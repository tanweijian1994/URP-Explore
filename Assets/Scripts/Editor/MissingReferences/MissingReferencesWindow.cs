...
namespace Game.Editor
{
    ...
    abstract class MissingReferencesWindow : EditorWindow
    {
        ...
        protected class GameObjectContainer : MissingReferencesContainer
        {
            ...
            public override UnityObject Object
            {
        ...
        static class Styles
        {
            ...
            const string k_IncludeEmptyEventsTooltip =
                "While scanning properties for missing references, include serialized UnityEvent references which do not have a target object. Missing references to target objects will be included whether or not this is set.";
